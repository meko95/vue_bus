...
<script>
  ...
  const getDeviceLineInfo = function (params) {
  ...
  export default {
    ...
    data() {
      return {
        ...
        option: {
          supportRemind: true,
          gridManagerName: 'DeviceLineInfo',
          height: '572px',
          ...
          ajax_data: (settings, params) => {
            ...
            console.log(params)
            return getDeviceLineInfo(params)
          },
          ajax_type: 'POST',
          supportMenu: true,
          query: {
          ...
          columnData: [
            ...
            },
            {
              ...
              width: '80px',
              align: 'center',
              template: '<span>005500</span>'
            }, {
              text: '上下行',
              key: 'xl',
              width: '60px',
              align: 'center',
              template: '<span>下行</span>'
            }, {
              text: '起讫站名称',
              key: 'tmbh',
              width: '120px',
              ...
              width: '200px',
              align: 'center',
              template: '<span>041073；045001；045002；045003</span>'
            },
            {
              text: 'RFID信号',
              key: 'ewmbh',
