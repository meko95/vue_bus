  ...
  <div>
    ...
    <el-container style="height: 707px; border: 1px solid #eee">
      ...
      <el-aside width="133px" style="background-color: rgb(238, 241, 246)">
        <span style="text-align: center; font-size: 24px">车辆标签</span>
      ...
      <el-container>
        <el-header>
          ...
          <div style="margin-left: 12px;display: inline">
            ...
            <el-button type="success" size="mini" @click="exportClbps" style="margin-left: 0px">
        ...
        <el-main>
          <div>
            ...
            <el-table ref="multipleTable" :data="Sbs" v-loading="tableLoading" border tooltip-effect="dark"
              ...
              <el-table-column prop="sbgsxlmc" label="线路" width="80" align="center"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      loadClbpData() {
        ...
        console.log(params)
        this.getRequest('http://localhost:8888/api/clbq/basic/jt1').then(res=>{
