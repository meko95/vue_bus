    ...
    <el-container>
      <el-header style="padding: 0px;display:flex;justify-content:space-between;align-items: center">
        <div style="display: inline">
          ...
          <el-select v-model="zgybp.sblb" size="mini" style="width: 200px;margin-left: 20px;padding: 0;" clearable
          ...
          <el-button type="primary" style="margin-left: 10px" size="mini" icon="el-icon-search" @click="searchZgybp">
            搜索
          </el-button>
        ...
        <div style="margin-left: 5px;margin-right: 20px;display: inline">
          <el-button type="success" size="mini" @click="exportZgybps">
            <i class="fa fa-lg fa-level-down" style="margin-right: 10px"></i>导出数据
          </el-button>
          <el-button type="primary" size="mini" icon="el-icon-plus" @click="showAddZgybpView">添加站杆预报屏
          </el-button>
        </div>
      ...
      <el-main style="padding-left: 20px;padding-top: 0">
        <div>
          ...
          <!-- RFID基础信息Begin -->
          <el-table ref="multipleTable" :data="zgybps" v-loading="tableLoading" border tooltip-effect="dark"
            ...
            <el-table-column prop="sbcz" label="材质" width="50" align="center"></el-table-column>
            <el-table-column prop="sbgd" label="供电" width="50" align="center"></el-table-column>
            <el-table-column prop="ytjqxd" label="清晰度" width="130" align="center"></el-table-column>
            <el-table-column prop="ytjcn" label="车内摄像头" width="100" align="center"></el-table-column>
            <el-table-column prop="ytjcw" label="车外摄像头" width="100" align="center"></el-table-column>
            ...
            <el-table-column fixed="right" label="操作" width="195" align="center">
              <template slot-scope="scope">
                <el-button @click="showEditZgybpView(scope.row)" style="padding: 5px 10px;margin: 6px"
                           size="large">编辑
                </el-button>
                <el-button type="danger" style="padding: 5px 10px;margin: 6px" size="large"
                           @click="deleteZgybp(scope.row)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
          ...
          <div style="display: flex;justify-content: space-between;margin: 2px">
            <el-button type="danger" size="small" v-if="zgybps.length>0" :disabled="multipleSelection.length==0"
                       @click="deleteManyZgybps">批量删除
            </el-button>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          sbgd: [{required: true, message: '必填:供电', trigger: 'blur'}],
